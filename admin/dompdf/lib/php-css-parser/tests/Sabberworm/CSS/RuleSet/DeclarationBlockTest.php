...
class DeclarationBlockTest extends TestCase
{
    ...
    public function expandShorthandProvider(): array
    {
        return [
            [
                ...
                function () {
                    return 'body {border-width: 2px;border-style: solid;border-color: #000;border-image: none;}' . PHP_EOL;
                },
            ],
            // ... other test cases
        ];
    ...
    public function createShorthandProvider(): array
    {
        return [
            [
                ...
                function () {
                    return 'body {border: 2px solid #000;}' . PHP_EOL;
                },
            ],
            // ... other test cases
        ];
    ...
    public function testOverrideRules(): void
    {
        ...
        $oWrapper->overrideRule($oRule, $oWrapper->getRules('left')[0]);

        $aRules = $oWrapper->getRules();
        $this->assertCount(2, $aRules);
